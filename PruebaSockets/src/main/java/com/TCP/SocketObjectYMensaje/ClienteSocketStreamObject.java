package com.TCP.SocketObjectYMensaje;
...
public class ClienteSocketStreamObject {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        try {
            ...
            ObjectInputStream flujoEntradaObjeto = new ObjectInputStream(
                    clientSocket.getInputStream());
            // 2. RECEPCION del OBJETO del servidor
            Integer numero = (Integer) flujoEntradaObjeto.readObject();
            System.out.println("CLIENTE: Recibiendo del SERVIDOR el numero: "
                    + numero);
